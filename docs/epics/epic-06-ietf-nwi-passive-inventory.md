...
- [ ] #77 - [Passive Component Classification, ODF/WDM/FAT/FDT/ATB Identity Mapping, and Connected Device End Reference Discovery](https://github.com/gintatkinson/3dgs-037/blob/main/docs/use-cases/uc-21-passive-component-classification-and-endpoint-discovery.md) (Provides passive component classification, device identity mapping, and endpoint discovery)
- [ ] #78 - [Fiber Cable Core Count Tracking, Multi-Tube Hierarchy Navigation, and Optical Attenuation Profiling](https://github.com/gintatkinson/3dgs-037/blob/main/docs/use-cases/uc-22-fiber-cable-strand-inventory-and-attenuation-profiling.md) (Provides fiber cable core count tracking, multi-tube hierarchy navigation, and optical attenuation profiling)
- [ ] #79 - [Splice Tray Capacity Monitoring, Fusion Joint Loss Calculation, and Fiber Strand Splicing Operations](https://github.com/gintatkinson/3dgs-037/blob/main/docs/use-cases/uc-23-splice-tray-capacity-and-fusion-joint-connection.md) (Provides splice tray capacity monitoring, fusion joint loss calculation, and fiber strand splicing operations)
- [ ] #80 - [Patch Panel Port Allocation, Optical Connector Insertion Loss Tracking, and Passive Port Classification](https://github.com/gintatkinson/3dgs-037/blob/main/docs/use-cases/uc-24-patch-panel-port-allocation-and-connector-loss-tracking.md) (Provides patch panel port allocation, optical connector insertion loss tracking, and passive port classification)

#### Associated User Stories
- [ ] #81 - [[ietf-nwi-passive-inventory]: Passive Component Classification, ODF/WDM/FAT/FDT/ATB Identity Mapping, and Connected Device End Reference Discovery](https://github.com/gintatkinson/3dgs-037/blob/main/docs/user-stories/us-28-passive-component-classification.md) (Provides passive component classification and connected device end reference discovery)
